...
EMBEDDINGS_DIR = "C:/face_embeddings5"  # Change to your desired directory
...
if __name__ == "__main__":
    ...
    output_dir = "C:/Users/Hp/Desktop/face-recognition/output1"  # Directory to save output images
