...
EMBEDDINGS_DIR = "C:/face_embeddings3"  # Change to your desired directory
...
if __name__ == "__main__":
    ...
    output_dir = "C:/Users/Hp/Desktop/face-recognition/output"  # Directory to save output images
